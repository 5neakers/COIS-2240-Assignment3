...
public class VehicleRentalTest {
    ...
    public class testSingletonRentalSystem {
        ...
        void testSingletonRentalSystem() throws Exception {
            ...
            Constructor<RentalSystem> constructor = RentalSystem.class.getDeclaredConstructor(); //setting up necessary constructor 

          
            int modifiers = constructor.getModifiers(); //get the modifiers 

          
            assertTrue(Modifier.isPrivate(modifiers), "This should ensure that the constructor remains private :)");
            
            RentalSystem instance = RentalSystem.getInstance(); //use this to obtain instance and insure not null 
